  ...
  return (
    ...
    <div>
      ...
      <div className="container w-100">
        ...
        <section className="guestbook pos-rel align-center pos-rel">
          <div className="d-flex row justify-around pb-2em">
            <h2 className="text-center text-cream">
              GUESTBOOK
            </h2>
          </div>
          <div className="d-flex row justify-around pb-2em">
            <div className="bg-footer-dark col d-flex justify-space p-1_5em col-4">
              <Form></Form>
            </div>
            <div className="bg-footer-dark col d-flex justify-space p-1_5em col-2 ">
              <List></List>
            </div>
          </div>
        </section>
